...
// MARK: - NetworkHandler
/// Defines a protocol to represent all the network functionality that is used to communicate with a REST endpoint, the encoding/decoding strategy, the different network requests (get, post, put, delete) and the authorization method.
public protocol NetworkHandler {
    ...
    /// implements a GET request for a RESTful interface
    ...
    /// implements a POST request for a RESTful interface
    /// - Parameters:
    ...
    /// implements a PUT request for a RESTful interface
    /// - Parameters:
    ...
    /// implements a DELETE request for a RESTful interface
